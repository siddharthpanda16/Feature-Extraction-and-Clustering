...
W_inv = np.linalg.inv(W)         # inverse of within class matrix
C = np.dot(W_inv,B)              #the ratio of between-class scatter and within-class scatter.

evals,evecs = np.linalg.eigh(C)  # Eigen Value and Vector of ratio of Between Class matrix and Within class matrix
